...
export default function Liderazgo() {
  ...
  const pastores = [
    { 
      ...
      bio: "Cristian sirve como pastor principal desde 2015. Su pasión es la predicación expositiva y el discipulado de nuevos líderes. Está casado con María y tienen tres hijos.", 
      img: "pastor-1" 
    },
    { 
      name: "David Torres", 
      title: "Pastor Asociado", 
      bio: "David supervisa los ministerios de enseñanza y la consejería bíblica. Tiene un corazón para ver a las familias crecer en la gracia. Está casado con Ana.", 
      img: "pastor-2" 
    },
    { 
      name: "Marcos Silva", 
      title: "Pastor de Jóvenes", 
      bio: "Marcos dedica su vida a equipar a la próxima generación con la verdad del Evangelio. Dirige el ministerio universitario y de jóvenes adultos.", 
      img: "pastor-3" 
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900 selection:bg-ibcd-blue selection:text-white">
      ...
      <section className="py-32 bg-white">
        <div className="container-custom">
          <h2 className="text-4xl md:text-5xl font-serif mb-16">Consejo Pastoral</h2>
          <div className="grid md:grid-cols-3 gap-12 lg:gap-16">
            {pastores.map((pastor, i) => (
              <div key={i} className="group cursor-pointer">
                <div className="aspect-[3/4] bg-slate-100 mb-8 overflow-hidden rounded-sm">
                  <img 
                    src={`https://picsum.photos/seed/${pastor.img}/600/800`} 
                    alt={pastor.name} 
